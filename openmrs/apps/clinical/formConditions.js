Bahmni.ConceptSet.FormConditions.rules = {
   'FSTG, Outcomes for 1st stage surgical validation' : function (formName, formFieldValues) {
          	...
          	if (conditionConcept=="Valid") {
          		conditions.enable.push("FSTG, Priority","FSTG, Name (s) of Surgeon 1","FSTG, Name (s) of Surgeon 2","FSTG, Comments:","FSTG, Outcomes for 1st stage Anaesthesia validation")
