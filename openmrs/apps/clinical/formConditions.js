  ...
  if (conditionConcept) {
	...
	'Microbiology, Final Identification': function (formName, formFieldValues) {
          ...
          if (conditionConcept == "Pseudomonas aeruginosa" || conditionConcept == "Pseudomonas putida"  || conditionConcept == "Pseudomonas fluorescens") {
              ...
              conditions.hide.push("ES, Ampicillin","ES, Gentamicin","ES, Vancomycin","ES, Norfloxacin")
              ...
              conditions.hide.push("CNS, Cefoxitin","CNS, Ciprofloxacin","CNS, Norfloxacin","CNS, Amikacin","CNS, Gentamicin","CNS, Tobramycin","CNS, Erythromycin","CNS, Clindamycin","CNS, D-zone:","CNS, Chloramphenicol","CNS, Trimeth-Sulfa","CNS, Fusidic acid","CNS, Rifampicin","CNS, Vancomycin MIC","CNS, Tetracycline","CNS, Teicoplanin","CNS, Levofloxacin")
              ...
              conditions.hide.push("Microbiology, Latex Agglutination")
               ...
               conditions.show.push("SA, Penicillin","SA, Penicillin sensitive zone:","SA, Cefoxitin","SA, Ciprofloxacin","SA, Norfloxacin","SA, Amikacin","SA, Gentamicin","SA, Tobramycin","SA, Erythromycin","SA, Clindamycin","SA, D-zone:","SA, Chloramphenicol","SA, Trimeth-Sulfa","SA, Fusidic acid","SA, Rifampicin","SA, Vanc MIC","SA, Tetracycline","SA, Teicoplanin","SA, Levofloxacin","SA, Doxycycline","SA, Linezolid")
               ...
               conditions.hide.push("SS, Penicillin","SS, Chloramphenicol","SS, Erythromycin","SS, Clindamycin","SS, D-zone:","SS, Norfloxacin","SS, Tetracycline","SS, Doxycycline","SS, Linezolid")
               conditions.hide.push("ES, Ampicillin","ES, Gentamicin","ES, Vancomycin","ES, Norfloxacin","ES, Linezolid")
               conditions.hide.push("SP, Oxacillin","SP, Trimeth-Sulfa","SP, Chloramphenicol","SP, Erythromycin","SP, Tetracycline","SP, Norfloxacin","SP, Doxycycline","SP, Linezolid")
               conditions.hide.push("SV, Penicillin","SV, Ampicillin","SV, Erythromycin","SV, Clindamycin","SV, D-zone:","SV, Vancomycin","SV, Ceftriaxone")
               conditions.hide.push("EB, Ampicillin","EB, Amikacin","EB, amoxicillin-clav ac","EB, Aztreonam","EB, Cefotaxime","EB, Cefoxitin","EB, Ciprofloxacin","EB, Gentamicin","EB, Ticarcillin","EB, Tobramycin","EB, Trimeto-sulfamet","EB, Cefepime","EB, Ertapenem","EB, Pip-tazobactam","EB, Ceftriaxone","EB, Ceftazidime","EB, ESBL screening:","EB, Meropenem","EB, Imipenem","EB, Levofloxacin","EB, Tigecycline","EB, Colistin")
               conditions.hide.push("NM, Penicillin G","NM, Ampicillin","NM, Ceftriaxone","NM, Ciprofloxacin","NM, Beta-Lactamase test performed")
               conditions.hide.push("HI, Penicillin","HI, Augmentin","HI, Ampicillin","HI, Trimeth-Sulfa","HI, Chloramphenicol","HI, Nalidixic acid")
               conditions.hide.push("LM, Penicillin","LM, Trimeth-Sulfa","LM, Erythromycin","LM, Ampicillin")
               conditions.hide.push("CNS, Cefoxitin","CNS, Ciprofloxacin","CNS, Norfloxacin","CNS, Amikacin","CNS, Gentamicin","CNS, Tobramycin","CNS, Erythromycin","CNS, Clindamycin","CNS, D-zone:","CNS, Chloramphenicol","CNS, Trimeth-Sulfa","CNS, Fusidic acid","CNS, Rifampicin","CNS, Vancomycin MIC","CNS, Tetracycline","CNS, Teicoplanin","CNS, Levofloxacin","CNS, Doxycycline","CNS, Linezolid")
               conditions.hide.push("AS, Imipenem","AS, Meropenem","AS, Ciprofloxacin","AS, Amikacin","AS, Gentamicin","AS, Tobramycin","AS, Levofloxacin","AS, Colistin")
               conditions.hide.push("CS, Penicillin","CS, Ciprofloxacin","CS, Gentamicin","CS, Vancomycin","CS, Clindamycin","CS, Tetracycine","CS, Rifampicin")
               conditions.hide.push("AXD, Piperacillin","AXD, Ticarcillin","AXD, Aztreonam","AXD, Tobramycine","AXD, Amikacin","AXD, Ticar-clav ac","AXD, Cefepime","AXD, Imipenem","AXD, Ceftazidime","AXD, Gentamicine","AXD, Ciprofloxacin","AXD, Meropenem","AXD, Piperacillin/Tazobactam","AXD, Trimethoprim/Sulfamethoxazole")
               conditions.hide.push("ASP, Cefepime","ASP, Ceftazidime","ASP, Aztreonam","ASP, Ciprofloxacin","ASP, Levofloxacin","ASP, Trimethoprim/Sulfamethoxazole")
               conditions.hide.push("SAM, Cefoxitin","SAM, Mupirocin")
               conditions.show.push("Microbiology, Are there any alerts?")
               conditions.show.push("Microbiology, Comments")
               conditions.hide.push("Microbiology, Latex Agglutination")
                ...
                conditions.show.push("SS, Penicillin","SS, Chloramphenicol","SS, Erythromycin","SS, Clindamycin","SS, D-zone:","SS, Norfloxacin","SS, Tetracycline","SS, Doxycycline", "SS, Linezolid")
                conditions.hide.push("SA, Penicillin","SA, Penicillin sensitive zone:","SA, Cefoxitin","SA, Ciprofloxacin","SA, Norfloxacin","SA, Amikacin","SA, Gentamicin","SA, Tobramycin","SA, Erythromycin","SA, Clindamycin","SA, D-zone:","SA, Chloramphenicol","SA, Trimeth-Sulfa","SA, Fusidic acid","SA, Rifampicin","SA, Vanc MIC","SA, Tetracycline","SA, Teicoplanin","SA, Levofloxacin","SA, Doxycycline","SA, Linezolid")
                conditions.hide.push("PS, Piperacillin","PS, Ticarcillin","PS, Aztreonam","PS, Tobramycine","PS, Amikacin","PS, Ticar-clav ac","PS, Cefepime","PS, Imipenem","PS, Ceftazidime","PS, Gentamicine","PS, Ciprofloxacin","PS, Meropenem","PS, Pip-tazobactam","PS, Levofloxacin","PS, Colistin")
                conditions.hide.push("ES, Ampicillin","ES, Gentamicin","ES, Vancomycin","ES, Norfloxacin","ES, Linezolid")
                conditions.hide.push("SP, Oxacillin","SP, Trimeth-Sulfa","SP, Chloramphenicol","SP, Erythromycin","SP, Tetracycline","SP, Norfloxacin","SP, Doxycycline","SP, Linezolid")
                conditions.hide.push("SV, Penicillin","SV, Ampicillin","SV, Erythromycin","SV, Clindamycin","SV, D-zone:","SV, Vancomycin","SV, Ceftriaxone")
                ...
                conditions.show.push("ES, Ampicillin","ES, Gentamicin","ES, Vancomycin","ES, Norfloxacin","ES, Linezolid")
                conditions.hide.push("PS, Piperacillin","PS, Ticarcillin","PS, Aztreonam","PS, Tobramycine","PS, Amikacin","PS, Ticar-clav ac","PS, Cefepime","PS, Imipenem","PS, Ceftazidime","PS, Gentamicine","PS, Ciprofloxacin","PS, Meropenem","PS, Pip-tazobactam","PS, Levofloxacin","PS, Colistin")
                conditions.hide.push("SA, Penicillin","SA, Penicillin sensitive zone:","SA, Cefoxitin","SA, Ciprofloxacin","SA, Norfloxacin","SA, Amikacin","SA, Gentamicin","SA, Tobramycin","SA, Erythromycin","SA, Clindamycin","SA, D-zone:","SA, Chloramphenicol","SA, Trimeth-Sulfa","SA, Fusidic acid","SA, Rifampicin","SA, Vanc MIC","SA, Tetracycline","SA, Teicoplanin","SA, Levofloxacin","SA, Doxycycline","SA, Linezolid")
                conditions.hide.push("SS, Penicillin","SS, Chloramphenicol","SS, Erythromycin","SS, Clindamycin","SS, D-zone:","SS, Norfloxacin","SS, Tetracycline","SS, Doxycycline","SS, Linezolid")
                conditions.hide.push("SP, Oxacillin","SP, Trimeth-Sulfa","SP, Chloramphenicol","SP, Erythromycin","SP, Tetracycline","SP, Norfloxacin","SP, Doxycycline","SP, Linezolid")
                ...
                conditions.show.push("SP, Oxacillin","SP, Trimeth-Sulfa","SP, Chloramphenicol","SP, Erythromycin","SP, Tetracycline","SP, Norfloxacin","SP, Doxycycline","SP, Linezolid")
                conditions.hide.push("PS, Piperacillin","PS, Ticarcillin","PS, Aztreonam","PS, Tobramycine","PS, Amikacin","PS, Ticar-clav ac","PS, Cefepime","PS, Imipenem","PS, Ceftazidime","PS, Gentamicine","PS, Ciprofloxacin","PS, Meropenem","PS, Pip-tazobactam","PS, Levofloxacin","PS, Colistin")
                conditions.hide.push("SA, Penicillin","SA, Penicillin sensitive zone:","SA, Cefoxitin","SA, Ciprofloxacin","SA, Norfloxacin","SA, Amikacin","SA, Gentamicin","SA, Tobramycin","SA, Erythromycin","SA, Clindamycin","SA, D-zone:","SA, Chloramphenicol","SA, Trimeth-Sulfa","SA, Fusidic acid","SA, Rifampicin","SA, Vanc MIC","SA, Tetracycline","SA, Teicoplanin","SA, Levofloxacin","SA, Doxycycline","SA, Linezolid")
                conditions.hide.push("SS, Penicillin","SS, Chloramphenicol","SS, Erythromycin","SS, Clindamycin","SS, D-zone:","SS, Norfloxacin","SS, Tetracycline","SS, Doxycycline","SS, Linezolid")
                conditions.hide.push("ES, Ampicillin","ES, Gentamicin","ES, Vancomycin","ES, Norfloxacin","ES, Linezolid")
           ...
           else if (conditionConcept == "Streptococcus viridans, alpha-hem"|| conditionConcept == "Streptococcus constellatus" || conditionConcept == "Streptococcus oralis" || conditionConcept == "Streptococcus milleri" || conditionConcept == "Streptococcus mitis" || conditionConcept == "Streptococcus salivarius") {
              ...
              conditionConcept =="Serratia liquefaciens" || conditionConcept == "Moraxella sp." || conditionConcept == "Providencia sp." ||
              conditionConcept == "Providencia rettregrei"
          ){
           ...
           else if (conditionConcept =="Staphylococcus epidermidis" || conditionConcept =="Staphylococcus saprophyticus ss. saprophyticus" || conditionConcept == "Staphylococcus chromogenes" ||
                   conditionConcept == "Staphylococcus intermedius"){
                conditions.show.push("CNS, Cefoxitin","CNS, Ciprofloxacin","CNS, Norfloxacin","CNS, Amikacin","CNS, Gentamicin","CNS, Tobramycin","CNS, Erythromycin","CNS, Clindamycin","CNS, D-zone:","CNS, Chloramphenicol","CNS, Trimeth-Sulfa","CNS, Fusidic acid","CNS, Rifampicin","CNS, Vancomycin MIC","CNS, Tetracycline","CNS, Teicoplanin","CNS, Levofloxacin","CNS, Doxycycline","CNS, Linezolid")
                conditions.hide.push("LM, Penicillin","LM, Trimeth-Sulfa","LM, Erythromycin","LM, Ampicillin")
                conditions.hide.push("HI, Penicillin","HI, Augmentin","HI, Ampicillin","HI, Trimeth-Sulfa","HI, Chloramphenicol","HI, Nalidixic acid")
                conditions.hide.push("PS, Piperacillin","PS, Ticarcillin","PS, Aztreonam","PS, Tobramycine","PS, Amikacin","PS, Ticar-clav ac","PS, Cefepime","PS, Imipenem","PS, Ceftazidime","PS, Gentamicine","PS, Ciprofloxacin","PS, Meropenem","PS, Pip-tazobactam","PS, Levofloxacin","PS, Colistin")
                conditions.hide.push("SA, Penicillin","SA, Penicillin sensitive zone:","SA, Cefoxitin","SA, Ciprofloxacin","SA, Norfloxacin","SA, Amikacin","SA, Gentamicin","SA, Tobramycin","SA, Erythromycin","SA, Clindamycin","SA, D-zone:","SA, Chloramphenicol","SA, Trimeth-Sulfa","SA, Fusidic acid","SA, Rifampicin","SA, Vanc MIC","SA, Tetracycline","SA, Teicoplanin","SA, Levofloxacin","SA, Doxycycline", "SA, Linezolid")
                ...
                conditions.show.push("AS, Imipenem","AS, Meropenem","AS, Ciprofloxacin","AS, Amikacin","AS, Gentamicin","AS, Tobramycin","AS, Levofloxacin","AS, Colistin")
                conditions.hide.push("CNS, Cefoxitin","CNS, Ciprofloxacin","CNS, Norfloxacin","CNS, Amikacin","CNS, Gentamicin","CNS, Tobramycin","CNS, Erythromycin","CNS, Clindamycin","CNS, D-zone:","CNS, Chloramphenicol","CNS, Trimeth-Sulfa","CNS, Fusidic acid","CNS, Rifampicin","CNS, Vancomycin MIC","CNS, Tetracycline","CNS, Teicoplanin","CNS, Levofloxacin","CNS, Doxycycline", "CNS, Linezolid")
                conditions.hide.push("LM, Penicillin","LM, Trimeth-Sulfa","LM, Erythromycin","LM, Ampicillin")
                conditions.hide.push("HI, Penicillin","HI, Augmentin","HI, Ampicillin","HI, Trimeth-Sulfa","HI, Chloramphenicol","HI, Nalidixic acid")
                conditions.hide.push("PS, Piperacillin","PS, Ticarcillin","PS, Aztreonam","PS, Tobramycine","PS, Amikacin","PS, Ticar-clav ac","PS, Cefepime","PS, Imipenem","PS, Ceftazidime","PS, Gentamicine","PS, Ciprofloxacin","PS, Meropenem","PS, Pip-tazobactam","PS, Levofloxacin","PS, Colistin")
                ...
                conditions.hide.push("SS, Penicillin","SS, Chloramphenicol","SS, Erythromycin","SS, Clindamycin","SS, D-zone:","SS, Norfloxacin","SS, Tetracycline","SS, Doxycycline", "SS, Linezolid")
                conditions.hide.push("ES, Ampicillin","ES, Gentamicin","ES, Vancomycin","ES, Norfloxacin","ES, Linezolid")
                conditions.hide.push("SP, Oxacillin","SP, Trimeth-Sulfa","SP, Chloramphenicol","SP, Erythromycin","SP, Tetracycline","SP, Norfloxacin","SP, Linezolid","SP, Doxycycline")
                conditions.hide.push("SV, Penicillin","SV, Ampicillin","SV, Erythromycin","SV, Clindamycin","SV, D-zone:","SV, Vancomycin","SV, Ceftriaxone")
                conditions.hide.push("EB, Ampicillin","EB, Amikacin","EB, amoxicillin-clav ac","EB, Aztreonam","EB, Cefotaxime","EB, Cefoxitin","EB, Ciprofloxacin","EB, Gentamicin","EB, Ticarcillin","EB, Tobramycin","EB, Trimeto-sulfamet","EB, Cefepime","EB, Ertapenem","EB, Pip-tazobactam","EB, Ceftriaxone","EB, Ceftazidime","EB, ESBL screening:","EB, Meropenem","EB, Imipenem","EB, Levofloxacin","EB, Tigecycline","EB, Colistin")
                conditions.hide.push("NM, Penicillin G","NM, Ampicillin","NM, Ceftriaxone","NM, Ciprofloxacin","NM, Beta-Lactamase test performed")
                conditions.hide.push("AXD, Piperacillin","AXD, Ticarcillin","AXD, Aztreonam","AXD, Tobramycine","AXD, Amikacin","AXD, Ticar-clav ac","AXD, Cefepime","AXD, Imipenem","AXD, Ceftazidime","AXD, Gentamicine","AXD, Ciprofloxacin","AXD, Meropenem","AXD, Piperacillin/Tazobactam","AXD, Trimethoprim/Sulfamethoxazole")
              ...
              conditions.show.push("AXD, Piperacillin","AXD, Ticarcillin","AXD, Aztreonam","AXD, Tobramycine","AXD, Amikacin","AXD, Ticar-clav ac","AXD, Cefepime","AXD, Imipenem","AXD, Ceftazidime","AXD, Gentamicine","AXD, Ciprofloxacin","AXD, Meropenem","AXD, Piperacillin/Tazobactam","AXD, Trimethoprim/Sulfamethoxazole")
              conditions.hide.push("CS, Penicillin","CS, Ciprofloxacin","CS, Gentamicin","CS, Vancomycin","CS, Clindamycin","CS, Tetracycine","CS, Rifampicin")
              conditions.hide.push("AS, Imipenem","AS, Meropenem","AS, Ciprofloxacin","AS, Amikacin","AS, Gentamicin","AS, Tobramycin","AS, Levofloxacin","AS, Colistin")
              conditions.hide.push("CNS, Cefoxitin","CNS, Ciprofloxacin","CNS, Norfloxacin","CNS, Amikacin","CNS, Gentamicin","CNS, Tobramycin","CNS, Erythromycin","CNS, Clindamycin","CNS, D-zone:","CNS, Chloramphenicol","CNS, Trimeth-Sulfa","CNS, Fusidic acid","CNS, Rifampicin","CNS, Vancomycin MIC","CNS, Tetracycline","CNS, Teicoplanin","CNS, Levofloxacin","CNS, Doxycycline", "CNS, Linezolid")
              conditions.hide.push("LM, Penicillin","LM, Trimeth-Sulfa","LM, Erythromycin","LM, Ampicillin")
              ...
              conditionConcept == "Micrococcus sp." || conditionConcept == "Stenotrophmonas maltophilia" || conditionConcept == "Shewanella sp." || conditionConcept == "Shewanella algae"
          ) {
                conditions.show.push("Microbiology, Comments")
                conditions.show.push("Microbiology, Are there any alerts?")
                conditions.hide.push("PS, Piperacillin","PS, Ticarcillin","PS, Aztreonam","PS, Tobramycine","PS, Amikacin","PS, Ticar-clav ac","PS, Cefepime","PS, Imipenem","PS, Ceftazidime","PS, Gentamicine","PS, Ciprofloxacin","PS, Meropenem","PS, Pip-tazobactam","PS, Levofloxacin","PS, Colistin")
          ...
          else if (conditionConcept == "Staphylococcus aureus. MRSA") {
              conditions.show.push("SAM, Cefoxitin", "SAM, Mupirocin")
              conditions.hide.push("PS, Piperacillin", "PS, Ticarcillin", "PS, Aztreonam", "PS, Tobramycine", "PS, Amikacin", "PS, Ticar-clav ac", "PS, Cefepime", "PS, Imipenem", "PS, Ceftazidime", "PS, Gentamicine", "PS, Ciprofloxacin", "PS, Meropenem", "PS, Pip-tazobactam", "PS, Levofloxacin", "PS, Colistin")
              conditions.hide.push("SS, Penicillin", "SS, Chloramphenicol", "SS, Erythromycin", "SS, Clindamycin", "SS, D-zone:", "SS, Norfloxacin", "SS, Tetracycline", "SS, Doxycycline", "SS, Linezolid")
              conditions.hide.push("ES, Ampicillin", "ES, Gentamicin", "ES, Vancomycin", "ES, Norfloxacin", "ES, Linezolid")
              conditions.hide.push("SP, Oxacillin", "SP, Trimeth-Sulfa", "SP, Chloramphenicol", "SP, Erythromycin", "SP, Tetracycline", "SP, Norfloxacin", "SP, Doxycycline", "SP, Linezolid")
          ...
          else if (conditionConcept == "Aeromonas Sp.") {
              conditions.show.push("ASP, Cefepime", "ASP, Ceftazidime", "ASP, Aztreonam", "ASP, Ciprofloxacin", "ASP, Levofloxacin", "ASP, Trimethoprim/Sulfamethoxazole")
              conditions.hide.push("PS, Piperacillin", "PS, Ticarcillin", "PS, Aztreonam", "PS, Tobramycine", "PS, Amikacin", "PS, Ticar-clav ac", "PS, Cefepime", "PS, Imipenem", "PS, Ceftazidime", "PS, Gentamicine", "PS, Ciprofloxacin", "PS, Meropenem", "PS, Pip-tazobactam", "PS, Levofloxacin", "PS, Colistin")
              conditions.hide.push("SS, Penicillin", "SS, Chloramphenicol", "SS, Erythromycin", "SS, Clindamycin", "SS, D-zone:", "SS, Norfloxacin", "SS, Tetracycline", "SS, Doxycycline", "SS, Linezolid")
              conditions.hide.push("ES, Ampicillin", "ES, Gentamicin", "ES, Vancomycin", "ES, Norfloxacin", "ES, Linezolid")
              conditions.hide.push("SP, Oxacillin", "SP, Trimeth-Sulfa", "SP, Chloramphenicol", "SP, Erythromycin", "SP, Tetracycline", "SP, Norfloxacin", "SP, Doxycycline", "SP, Linezolid")
