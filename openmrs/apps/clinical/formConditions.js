	...
	'Microbiology, Final Identification': function (formName, formFieldValues) {
          ...
          if (conditionConcept == "Pseudomonas aeruginosa") {
              ...
              conditions.hide.push("Microbiology, Comments","Microbiology, Latex Agglutination")
               ...
               conditions.show.push("SA, Penicillin","SA, Penicillin sensitive zone:","SA, Cefoxitin","SA, Ciprofloxacin","SA, Norfloxacin","SA, Amikacin","SA, Gentamicin","SA, Tobramycin","SA, Erythromycin","SA, Clindamycin","SA, D-zone:","SA, Chloramphenicol","SA, Trimeth-Sulfa","SA, Fusidic acid","SA, Rifampicin","SA, Vanc MIC","SA, Tetracycline","SA, Teicoplanin","SA, Levofloxacin")
               ...
               conditions.hide.push("Microbiology, Comments","Microbiology, Latex Agglutination")
                ...
                conditions.show.push("ES, Ampicillin","ES, Gentamicin","ES, Vancomycin","ES, Norfloxacin")
                conditions.hide.push("PS, Piperacillin","PS, Ticarcillin","PS, Aztreonam","PS, Tobramycine","PS, Amikacin","PS, Ticar-clav ac","PS, Cefepime","PS, Imipenem","PS, Ceftazidime","PS, Gentamicine","PS, Ciprofloxacin","PS, Meropenem","PS, Pip-tazobactam","PS, Levofloxacin","PS, Colistin")
                conditions.hide.push("SA, Penicillin","SA, Penicillin sensitive zone:","SA, Cefoxitin","SA, Ciprofloxacin","SA, Norfloxacin","SA, Amikacin","SA, Gentamicin","SA, Tobramycin","SA, Erythromycin","SA, Clindamycin","SA, D-zone:","SA, Chloramphenicol","SA, Trimeth-Sulfa","SA, Fusidic acid","SA, Rifampicin","SA, Vanc MIC","SA, Tetracycline","SA, Teicoplanin","SA, Levofloxacin")
                conditions.hide.push("SS, Penicillin","SS, Chloramphenicol","SS, Erythromycin","SS, Clindamycin","SS, D-zone:","SS, Norfloxacin","SS, Tetracycline")
                conditions.hide.push("SP, Oxacillin","SP, Trimeth-Sulfa","SP, Chloramphenicol","SP, Erythromycin","SP, Tetracycline","SP, Norfloxacin")
              ...
              conditions.show.push("AXD, Piperacillin","AXD, Ticarcillin","AXD, Aztreonam","AXD, Tobramycine","AXD, Amikacin","AXD, Ticar-clav ac","AXD, Cefepime","AXD, Imipenem","AXD, Ceftazidime","AXD, Gentamicine","AXD, Ciprofloxacin","AXD, Meropenem")
              conditions.hide.push("CS, Penicillin","CS, Ciprofloxacin","CS, Gentamicin","CS, Vancomycin","CS, Clindamycin","CS, Tetracycine","CS, Rifampicin")
              conditions.hide.push("AS, Imipenem","AS, Meropenem","AS, Ciprofloxacin","AS, Amikacin","AS, Gentamicin","AS, Tobramycin","AS, Levofloxacin","AS, Colistin")
              conditions.hide.push("CNS, Cefoxitin","CNS, Ciprofloxacin","CNS, Norfloxacin","CNS, Amikacin","CNS, Gentamicin","CNS, Tobramycin","CNS, Erythromycin","CNS, Clindamycin","CNS, D-zone:","CNS, Chloramphenicol","CNS, Trimeth-Sulfa","CNS, Fusidic acid","CNS, Rifampicin","CNS, Vancomycin MIC","CNS, Tetracycline","CNS, Teicoplanin","CNS, Levofloxacin")
              conditions.hide.push("LM, Penicillin","LM, Trimeth-Sulfa","LM, Erythromycin","LM, Ampicillin")
