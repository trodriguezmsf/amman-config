...
"SELECT  `identifier` , Name , uuid , `Name of MLO` , `Nationality` , `Specialty`
  FROM (SELECT
        ...
        FROM person p
          ...
          JOIN concept_name obs_fscn ON o.concept_id = obs_fscn.concept_id AND
                                        obs_fscn.name IN
                                        ('FSTG, Date received', 'FSTG, Date of presentation at 1st stage','MH, Name of MLO', 'FSTG, Specialty determined by MLO')
