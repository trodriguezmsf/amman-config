...
"SELECT  `Date of Presentation` ,  `identifier`, Name , uuid , `Nationality` ,`Name of MLO`,`Specialty`,`Outcomes for 1st stage surgical validation`,`Outcomes for 1st stage Anaesthesia validation`,`Comments About Postpone Reason`,`Type of Medical Information Needed for Next Submission`
    FROM (SELECT
          ...
          FROM person p
            ...
            JOIN concept_name obs_fscn ON o.concept_id = obs_fscn.concept_id AND
                                          obs_fscn.name IN
                                          ('FSTG, Date of presentation at 1st stage','FSTG, Outcomes for 1st stage surgical validation','FSTG, Outcomes for 1st stage Anaesthesia validation','FSTG, Specialty determined by MLO','FSTG, Comments about postpone reason','FSTG, Type of medical information needed for next submission')
