DELETE FROM global_property WHERE property = 'bahmni.sqlGet.physiotherapyPainAssessment1';
SELECT uuid() INTO @uuid;

INSERT INTO global_property (property, property_value, description, uuid)
 VALUES ('bahmni.sqlGet.physiotherapyPainAssessment1', "
 SELECT
    c_sn.name as concept_name,
    o.value_numeric as answer_concept_name,
    o.obs_group_id
FROM
    person p
...
FROM
    ...
    p.uuid = ${patientUuid}
  ;"
  , 'PhysiotherapyPainAssessment1', @uuid);