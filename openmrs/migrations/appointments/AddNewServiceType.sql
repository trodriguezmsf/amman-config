CREATE PROCEDURE add_new_service_type (service_name VARCHAR(255),
                             service_description VARCHAR(255),
                             service_color_hex VARCHAR(255),
...
BEGIN
 ...
 DECLARE appointment_service_type_count INT;
  ...
  IF @appointment_service_count = 0 THEN
     ...
     (service_name,service_description,NULL,NULL,service_location_id,NULL,NULL,service_duration,service_color_hex,now(),user_id_proc,now(),user_id_proc,0,NULL,NULL,NULL,uuid());
  END IF;
