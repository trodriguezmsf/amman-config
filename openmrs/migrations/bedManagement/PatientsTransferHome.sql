...
WHERE v.date_stopped IS NULL AND cn.name = 'Transfer Home' AND v.visit_id NOT IN (SELECT visit_id
                                                                                  FROM encounter ie
...
GROUP BY pi.identifier;",'Patients Transfer to home',@uuid);