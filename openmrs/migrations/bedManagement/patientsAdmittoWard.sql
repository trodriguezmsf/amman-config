...
WHERE v.date_stopped IS NULL AND cn.name = 'Admit to Ward' AND p.person_id NOT IN (SELECT patient_id
                                                                                   FROM bed_patient_assignment_map bpam
...
ORDER BY o.obs_datetime;",'Patients Admit to Ward',@uuid);