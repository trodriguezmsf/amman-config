...
"SELECT DISTINCT
        ...
        WHERE v.date_stopped IS NULL AND v.voided = 0 AND o.voided = 0 AND cn.name = 'Movement to Kahramana' AND e1.encounter_id IS NULL;",'Patients Movement to Kahramana',@uuid);