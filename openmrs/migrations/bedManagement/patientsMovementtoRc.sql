...
WHERE v.date_stopped IS NULL AND cn.name = 'Movement to RC' AND v.visit_id NOT IN (SELECT visit_id
                                                                                  FROM encounter ie
...
GROUP BY pi.identifier;",'Patients Movement to RC',@uuid);