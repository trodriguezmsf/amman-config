DELETE FROM global_property WHERE property = 'emrapi.sqlSearch.PatientsMovementtoRc';
SELECT uuid() INTO @uuid;
INSERT INTO global_property (`property`, `property_value`, `description`, `uuid`)
VALUES ('emrapi.sqlSearch.PatientsMovementtoRc',
"SELECT DISTINCT
        ...
        INNER JOIN concept_name cn ON o.value_coded = cn.concept_id AND cn.concept_name_type = 'FULLY_SPECIFIED' AND cn.voided is FALSE
                                                                    AND cn.name = 'Movement to RC' AND o.obs_datetime > bpame.date_created
    WHERE v.date_stopped IS NULL AND v.voided = 0 AND o.voided = 0
    ORDER BY o.obs_datetime;",'Patients Movement to RC',@uuid);