...
FROM
  ...
  LEFT JOIN (SELECT pa.value AS careTakerName, pa.person_id
             FROM person_attribute pa
               JOIN person_attribute_type pat
                 ON pa.person_attribute_type_id = pat.person_attribute_type_id AND pat.retired IS FALSE AND pat.name = 'caretakerNameEnglish' AND pa.voided IS FALSE
