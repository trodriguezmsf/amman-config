 DELETE FROM global_property where property = 'emrapi.sqlSearch.newModifiedPrescription';
 select uuid() into @uuid;
 INSERT INTO global_property (`property`, `property_value`, `description`, `uuid`)
 VALUES ('emrapi.sqlSearch.newModifiedPrescription',
"SELECT
  pi.identifier,
...
FROM
  ...
  LEFT OUTER JOIN (
            ...
            ) bed on bed.patient_id = p.person_id", 'New/Modified Prescriptions',@uuid);