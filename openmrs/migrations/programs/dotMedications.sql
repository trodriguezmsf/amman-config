DELETE FROM global_property where property = 'emrapi.sqlSearch.dotMedications';
select uuid() into @uuid;
INSERT INTO global_property (`property`, `property_value`, `description`, `uuid`)
VALUES ('emrapi.sqlSearch.dotMedications',
        "SELECT
        ...
        FROM
          ...
          INNER JOIN (
                       ...
                       FROM patient p
                         ...
                         LEFT JOIN drug_order drug_order ON drug_order.order_id = orders.order_id AND drug_order.as_needed = 1
        ...
        ORDER BY medications.date_created DESC;", 'DOT Medications',@uuid);